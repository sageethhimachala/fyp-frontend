export default function AtomGrid({ atoms, selectedAtomIndex, onSelectAtom }) {
  return (
    <div>
      <style>{`.atom-grid.no-scrollbar::-webkit-scrollbar{width:0;height:0}.atom-grid.no-scrollbar{scrollbar-width:none;-ms-overflow-style:none}`}</style>
      <div
        className="atom-grid no-scrollbar"
        style={{
          height: "620px",
          overflow: "auto",
            ...
            {atoms.map((atom, index) => {
              ...
              return (
                <tr
                  ...
                  style={{
                    background: selected ? "#0f2740" : "transparent",
                    cursor: "pointer",
                    color: selected ? "#e6f6ff" : undefined,
                  }}
                >
